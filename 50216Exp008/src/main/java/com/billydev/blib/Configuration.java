...
public class Configuration {
	...
	public static String JOB_STATE_READY="06"; 
	
	
	public static String JOB_TYPE_UNIX="UNIX";
	public static String JOB_TYPE_LINK="LINK"; 
	public static String JOB_TYPE_TASK="TASK"; 
